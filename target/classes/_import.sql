...
insert into produto(id, nome, descricao, preco, restaurante_id, ativo) values (1, 'Arroz', 'Do bom', 18.99, 1,true);
insert into produto(id, nome, descricao, preco, restaurante_id, ativo) values (2, 'Feijao', 'Do bom', 4.99, 2,true);
insert into produto(id, nome, descricao, preco, restaurante_id, ativo) values (3, 'Carne', 'Da boa', 32.99,1,true);